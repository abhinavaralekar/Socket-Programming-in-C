...
char message[100];
char *service="echo";
char errmsg[1000]="No characters entered.Please enter the statement of your choice\n ";
...
int serversock,type,acceptsock,message;
...
if(setsockopt(serversock,SOL_SOCKET,SO_REUSEPORT,(const char*)&message,sizeof(message))<0)
{
